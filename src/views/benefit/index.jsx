...
const Benefit = ({ datas }) => {
  ...
  const paginatedBenefits = datas.slice(startIndex, startIndex + itemsPerPage);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        console.error("Failed to add benefit:", await res.text());
      }
    } catch (err) {
    ...
    <div className="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
          ...
          >
            <div className="mb-5">
              ...
              <input
                type="text"
                id="name"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-auto min-w-[250px] h-8 p-2 text-md dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {paginatedBenefits.map((data, index) => (
              <tr
                key={index}
